...
import patternBackground from './images/pattern.jpg';
...
export default class Login extends React.Component {
  constructor(props) {
	...
	this.state = {
		formFields : {
			username : 'thinhld9xvn@gmail.com',
  ...
  componentDidMount() {
	...
	document.body.style.backgroundImage = 'url(' + patternBackground + ')';
			...
			<div className="w100p">
				<div className="login-container">
					<div className="center">
						<h1>
							<img src={logoSvg} className="logo-login" alt="logo" />
							<span className="red mg-right5">GCO</span>
							<span className="grey" id="id-text2">ASTRA CMS</span>
						</h1>
						<h4 className="blue" id="id-company-text">© GCO GROUP 2020 - 2021</h4>
					</div>
